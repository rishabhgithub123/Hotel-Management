					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-striped custom-table" id="table">
								...
								<%
								try{
      								ptr = con.prepareStatement("SELECT * from payment_info;");
	  								ResultSet rs=ptr.executeQuery();
									out.println("<thead><tr><th>Booking ID</th><th>Payment Type</th><th>Payment Date</th><th>Amount</th><th>Status</th><th class=text-right>Action</th></tr></thead><tbody>");
	  								while(rs.next()) {
	  								out.println("<tr>");
									...
									out.println("");
									out.println("<a class=\"dropdown-item\" href=\"javascript:{}\" onclick=\"document.getElementById('hiddentext1').submit();\"><i class=\"fa fa-pencil m-r-5\"></i> View Receipt</a>");
									out.println("<a class=\"dropdown-item\" href=\"#\" data-toggle=\"modal\" data-target=\"#delete_room\"><i class=\"fa fa-trash-o m-r-5\"></i> Payment</a>");	
								...
								<form method="get" id="hiddentext1" action="receipt.jsp"><input type="text" id="tf1" name="firstbox" style="display: none" /></form>
							</table>
						</div>
					</div>
                </div>
				...
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						<div class="modal-body text-center">
							...
							<h3>Are you sure want to Pay...?</h3>
							<div class="m-t-20"> 
								<form method="get" id="hiddentext2" action="payment.jsp"><input type="text" id="tf2" name="firstbox" style="display: none" />
