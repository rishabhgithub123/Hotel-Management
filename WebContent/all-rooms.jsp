            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-8 text-right m-b-20">
                        <a href="add-room.jsp" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Room</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-striped custom-table" id="table">
								...
								<%
								try{
      								ptr = con.prepareStatement("SELECT room_info.room_no, room_info.room_type,room_info.floor, room_rate.room_rate, room_info.status FROM room_info JOIN room_rate ON room_info.room_type=room_rate.room_type order by room_info.room_no;");
	  								ResultSet rs=ptr.executeQuery();
									out.println("<thead><tr><th style=width:20%;>Room Number</th><th style=width:20%;>Room Type</th><th style=width:10%;>Floor</th><th style=width:20%;>Rent</th><th style=width:20%;>Status</th><th class=text-right>Action</th></tr></thead><tbody>");
	  								while(rs.next()) {
	  								out.println("<tr>");
	  								out.println("<td>"+rs.getInt(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getInt(4)+"</td><td>"+rs.getString(5)+"</td>");
								...
								%>	
								<!-- For Select The Room Id This is hidden textbox form -->
								<form method="get" id="hiddentext1" action="edit-room.jsp"><input type="text" id="tf1" name="firstbox" style="display: none" /></form>
							</table>
						</div>
					</div>
                </div>
				...
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						<div class="modal-body text-center">
							...
							<div class="m-t-20"> 
								<form method="get" id="hiddentext2" action="Delete_room"><input type="text" id="tf2" name="firstbox" style="display: none" />
