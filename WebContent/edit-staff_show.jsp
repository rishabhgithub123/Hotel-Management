    ...
    <div class="main-wrapper">
        ...
        <%
					...
					try{
							...
							ptr = con.prepareStatement("SELECT count(staff_id) FROM hotel_management.staff_info where staff_id ="+staff_id);
							ResultSet rs2=ptr.executeQuery();
							rs2.next();
							if(rs2.getInt(1)==1) {
								ptr = con.prepareStatement("SELECT * FROM hotel_management.staff_info where staff_id ="+staff_id);
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="staff ID" name="tf1" id="staff_id" onkeyup="sync()" value="<%out.println(rs1.getInt(1));%>" readonly/>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label >Name <span class="text-danger">*</span></label> 
										<input type="text" class="form-control" placeholder="Name" value="<%out.println(rs1.getString(2));%>" disabled />
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label>Email <span class="text-danger">*</span></label> <input
											class="form-control" type="email" name="tf2" placeholder="email" value="<%out.println(rs1.getString(4));%>">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label>Phone </label> <input class="form-control" type="text" name="tf3" value="<%out.println(rs1.getString(5));%>"
											placeholder="Phone No">
									</div>
								</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label>Address </label> <input class="form-control" type="text" name="tf4" value="<%out.println(rs1.getString(8));%>"
										placeholder="Address">
								</div>
							</div>
						</div>
