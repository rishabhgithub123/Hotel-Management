...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
			<div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="get" action="Edit_room">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Room Number</label>
                                        <input name ="room_no" id="room_number" class="form-control" type="text" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
	...
	<script>
            ...
            $(function () {
            	document.getElementById("room_number").value = $.urlParam('firstbox');
			})
