                    ...
                    <div class="col-md-12">
						<div class="table-responsive">
                            <table class="table table-striped custom-table" id="table">
                            	...
                            	<%
								try{
      								ptr = con.prepareStatement("SELECT * from feedback_info;");
	  								ResultSet rs=ptr.executeQuery();
									out.println("<thead><tr><th style=width:200px;>Feedback ID</th><th style=width:150px;>Name</th><th>Feedback</th></tr></thead><tbody>");
	  								while(rs.next()) {
	  								out.println("<tr>");
	  								out.println("<td>"+rs.getInt(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td></tbody>");
	  								}
