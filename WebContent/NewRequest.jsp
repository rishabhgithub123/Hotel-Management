        ...
        <div class="page-wrapper">
                ...
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Booking Request</h4>
                    </div>
                    ...
                    <div class="col-md-12">
						<div class="table-responsive">
                            <table class="table table-striped custom-table" id="table">
                            	...
                            	<%
								try{
      								ptr = con.prepareStatement("select * from customer_info");
	  								ResultSet rs=ptr.executeQuery();
									out.println("<thead><tr><th>Customer ID</th><th>Name</th><th>Contact</th><th>Check IN</th><th>Check Out</th><th>Room Type</th><th class=text-right>Action</th></tr></thead><tbody>");
	  								while(rs.next()) {
	  								out.println("<tr>");
	  								out.println("<td>"+rs.getInt(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getDate(4)+"</td><td>"+rs.getDate(5)+"</td><td>"+rs.getString(6)+"</td>");
				...
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						<div class="modal-body text-center">
							...
							<div class="m-t-20"> 
								<form method="get" id="hiddentext2" action="Delete_customer"><input type="text" id="tf2" name="firstbox" style="display: none;"/>
